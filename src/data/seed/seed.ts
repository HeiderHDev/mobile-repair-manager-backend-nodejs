...
async function main() {
  ...
  try {
    // 0. Deshabilitar foreign key checks temporalmente
    await MySQLDatabase.connection.query('SET FOREIGN_KEY_CHECKS = 0;');
    ...
    await MySQLDatabase.connection.query('SET FOREIGN_KEY_CHECKS = 1;');
    ...
    // 3. Crear teléfonos
    const phonesData = [
      // Teléfonos para Juan Carlos (cliente 1)
      {
      ...
      // Teléfonos para María Elena (cliente 2)
      {
      ...
      // Teléfono para Carlos Alberto (cliente 3)
      {
      ...
      // Teléfonos para Ana Sofía (cliente 4)
      {
      ...
      // Teléfono para Roberto (cliente 5)
      {
    ...
    // 4. Crear reparaciones con historial realista
    const repairsData = [
      // Reparaciones para Samsung Galaxy S23 (teléfono 1)
      {
      ...
      // Reparaciones para iPhone 14 Pro (teléfono 2)
      {
      ...
      // Reparaciones para Xiaomi Redmi Note 12 (teléfono 3)
      {
      ...
      // Reparaciones para Samsung Galaxy A54 (teléfono 4)
      {
      ...
      // Reparaciones para Huawei P50 Pro (teléfono 5)
      {
      ...
      // Reparaciones para iPhone 13 (teléfono 6)
      {
